...
if __name__ == "__main__":
    f = h5.File('/mnt/home/spandey/ceph/CHARFORMER/data/PM/df_halo_part_ngp_xyz_worig_vel_M_tokenized_PM_512x512x512_density3Dgrid_32_isim_0_snap_3_nvocab64_Mmin_13p5.h5', 'r')    
    dfhalo_ngp_xyzM_tokenized_padded_ended_squeezed_all = f['dfhalo_ngp_xyzM_tokenized_padded_ended_squeezed_all'][:]
    delta_box_all_squeezed_all = f['delta_vel_box_all_squeezed_all'][:]
    ninp_delta = delta_box_all_squeezed_all.shape[1]
...
def run_func():
    ...
    # if rank == 0: 
    # checkpoint = torch.load('/mnt/home/spandey/ceph/CHARFORMER/model_checkpoints/model_encdec_ddp_PM_wvel_isim_012_nvocab_64_nembed_64_Mmin_13p5.pt', map_location=f'cuda:{device_id}')
    # checkpoint = torch.load('/mnt/home/spandey/ceph/CHARFORMER/model_checkpoints/model_encdec_ddp_PM_wvel_isim_012_nvocab_64_nembed_64_Mmin_13p5.pt', map_location=f'cuda:{device_id}')    
        ...
        if iter_num % eval_interval == 0 and (rank == 0):
                ...
                if losses['val'] < best_val_loss:
                    ...
                    if iter_num > 0:
                        ...
                        torch.save(checkpoint, '/mnt/home/spandey/ceph/CHARFORMER/model_checkpoints/model_encdec_ddp_PM_wvel_isim_0_nvocab_64_nembed_96_Mmin_13p5_wvelorig.pt')                                 

                        if iter_num % save_separate_interval == 0 and (rank == 0):
                            # torch.save(checkpoint, f'/mnt/home/spandey/ceph/CHARFORMER/model_checkpoints/model_encdec_ddp_PM_wvel_isim_012_nvocab_64_nembed_64_Mmin_13p5_iter_8400_plus_{iter_num}.pt')
                            torch.save(checkpoint, f'/mnt/home/spandey/ceph/CHARFORMER/model_checkpoints/model_encdec_ddp_PM_wvel_isim_0_nvocab_64_nembed_96_Mmin_13p5_wvelorig_iter_{iter_num}.pt')
