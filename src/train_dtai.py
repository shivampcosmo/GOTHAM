...
def train():
    ...
    cp_name = f'/projects/bdne/spandey3/GOTHAM/model_checkpoints/camels_photo/model_encdec_ddp_PM_nvocab_64_nembed_64_nrandsubsel_{int(nrand_sel_box/subsamp_ds)}_RUN1.pt'
        ...
        if iter_num % eval_interval == 0 and (rank == 0):
                ...
                if losses['val'] < best_val_loss:
                    ...
                    if iter_num > 0:
                        ...
                        torch.save(checkpoint, f'/projects/bdne/spandey3/GOTHAM/model_checkpoints/camels_photo/model_encdec_ddp_PM_nvocab_64_nembed_64_nrandsubsel_{int(nrand_sel_box/subsamp_ds)}.pt')                                 

                        if iter_num % save_separate_interval == 0 and (rank == 0):
                            torch.save(checkpoint, f'/projects/bdne/spandey3/GOTHAM/model_checkpoints/camels_photo/model_encdec_ddp_PM_nvocab_64_nembed_64_nrandsubsel_{int(nrand_sel_box/subsamp_ds)}_iter_{iter_num}.pt')
