...
f = h5.File('/mnt/home/spandey/ceph/CHARFORMER/data/PM/df_halo_part_ngp_xyzM_tokenized_PM_384x384x384_density3Dgrid_32_isim_012_snap_3_FINAL.h5', 'r')
...
def demo_basic():
    ...
    # if rank == 0: 
    checkpoint = torch.load('/mnt/home/spandey/ceph/CHARFORMER/model_checkpoints/model_encdec_ddp_PM_isim_012_nvocab_96_nembed_64_CORRMASK_NOFLASH_FINAL.pt', map_location=f'cuda:{device_id}')
        ...
        if iter_num % eval_interval == 0 and (rank == 0):
                ...
                if losses['val'] < best_val_loss:
                    ...
                    if iter_num > 0:
                        ...
                        torch.save(checkpoint, '/mnt/home/spandey/ceph/CHARFORMER/model_checkpoints/model_encdec_ddp_PM_isim_012_nvocab_96_nembed_64_CORRMASK_NOFLASH_FINAL.pt')                                 

                        if iter_num % save_separate_interval == 0 and (rank == 0):
                            torch.save(checkpoint, f'/mnt/home/spandey/ceph/CHARFORMER/model_checkpoints/model_encdec_ddp_PM_isim_012_nvocab_96_nembed_64_CORRMASK_NOFLASH_FINAL_{iter_num}.pt')
