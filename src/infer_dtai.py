...
checkpoint = torch.load(f'/projects/bdne/spandey3/halo_gotham/GOTHAM/model_checkpoints/quijote_halos/{prefix}_TEST_model_hres_encdec_ddp_grid_8_nvocab_64_nembed_256_nhead_8_nrandsubsel_2048_subselDMOfields_all_Mstarcut_12.7_spacetoken_False_maxiter_1500_lr_0.0005.pt')
...
# isim_fid_array = np.arange(114, 115)
isim_fid_array = np.arange(113, 119)
for isim_fid in (isim_fid_array):
    ...
    import pickle as pk
    with open(f'/projects/bdne/spandey3/halo_gotham/GOTHAM/infer_data/{prefix}_TEST_infer_halos_ng32_grid_{grid_sbox}_isim_fid_{isim_fid_array[0]}_{isim_fid_array[-1]}_nrandsubsel_32768_Mstarcut_{Mstar_cut}_spacetoken_{add_space_token}.pkl', 'wb') as f:
        pk.dump(saved_all, f)
