...
def load_halo_catalog(isim, cosmo_params):
    ...
    rockstar = np.loadtxt(f"/work/hdd/bdne/yzhang116/quijote/halo_catalogs/halo_LH_{isim}.dat")
...
def process_LH_sim(isim, use_numba=True, randsel=True):
    ...
    sdir_isim = "/work/hdd/bdne/yzhang116/quijote/halo_sentences"
    ...
    if os.path.exists(savefname):
        ...
        cosmo = np.loadtxt('/work/nvme/bdne/yzhang116/quijote_halos/quijote_params.txt')[isim]
