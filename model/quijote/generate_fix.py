...
ckpt_path = f'/work/hdd/bdne/yzhang116/checkpoints_quijote/1872236/checkpoint_new.pt'
                            ...
                            for jh in range(int(Nhalos_here)):
                                try:
                                    ...
                                    for jp in range(dim_prop):
                                        ...
                                        prop_all[jp] = (bins_digitize[jp, bin_val_jp]).clip(min=bins_digitize[jp,0], max=bins_digitize[jp,-1])
...
if 1:
    ...
    data = np.int16(data)
    output_dir = '/work/hdd/bdne/yzhang116/generate_catalog_quijote/comp_Om'
    out_filename =  os.path.join(output_dir, f'generated_halos_sentence_{simid}_Om_m0p1.npy')
    ...
    out_filename =  os.path.join(output_dir, f'generated_halo_catalog_{simid}_Om_m0p1.npy')
