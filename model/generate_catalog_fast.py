...
#dmo_dir = '/work/hdd/bdne/yzhang116/quijote/test_3gpc/dmo/disco/'
...
if 1:
    ...
    output_dir = '/work/hdd/bdne/yzhang116/generate_catalog_quijote'
    os.makedirs(output_dir, exist_ok=True)
    out_filename =  os.path.join(output_dir, f'generated_halo_catalog_{simid}_v4.npy')
