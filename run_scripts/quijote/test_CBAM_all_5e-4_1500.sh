...
srun --export=ALL python `which torchrun` \
        ...
        train_dtai.py --grid_sbox=8 --add_space_token=False --subsel_type=all --learning_rate=0.005 --max_iters=400 --loss_type=cross_entropy --cnn_type=res_cbam
echo "done"
