...
#SBATCH --job-name=hres_test
#SBATCH --partition=ghx4
#SBATCH --mem=256G
#SBATCH --exclusive
#SBATCH --gpus-per-node=4
#SBATCH --gpu-bind=verbose,closest
#SBATCH --output=/projects/bdne/spandey3/halo_gotham/GOTHAM/run_scripts/quijote/FULL_wposembed_vit/logs/%x.%j.out
#SBATCH --error=/projects/bdne/spandey3/halo_gotham/GOTHAM/run_scripts/quijote/FULL_wposembed_vit/logs/%x.%j.err
...
srun --export=ALL python `which torchrun` \
        ...
        train_dtai_Mstar12p7_HRES_MDIFF.py --grid_sbox=8 --add_space_token=False --subsel_type=all --learning_rate=0.0005 --max_iters=400 --n_embd=256 --patch_size=1 --loss_type=cross_entropy --cnn_type=vit_cbam
echo "done"
