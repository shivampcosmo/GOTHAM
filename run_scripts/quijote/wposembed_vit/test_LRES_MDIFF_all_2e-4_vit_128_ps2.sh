...
srun --export=ALL python `which torchrun` \
        ...
        train_dtai_LRES_MDIFF.py --grid_sbox=8 --add_space_token=False --subsel_type=all --learning_rate=0.0002 --max_iters=400 --n_embd=128 --patch_size=2 --loss_type=cross_entropy --cnn_type=vit
echo "done"
