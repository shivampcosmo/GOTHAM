...
srun --export=ALL python `which torchrun` \
        ...
        train_dtai_Mstar12p7_LRES_MDIFF.py --grid_sbox=8 --add_space_token=False --subsel_type=all --learning_rate=0.0002 --max_iters=600 --n_embd=128 --patch_size=1 --loss_type=cross_entropy --cnn_type=vit_cbam
echo "done"
