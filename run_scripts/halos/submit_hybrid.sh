...
srun python train_hybrid_transformer.py
...
#         train_dtai_LRES_MDIFF.py --grid_sbox=8 --add_space_token=False --subsel_type=all --learning_rate=0.001 --max_iters=400 --n_embd=128 --loss_type=cross_entropy --cnn_type=vit
echo "done"
