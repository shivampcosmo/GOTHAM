...
SCRIPT_DIR="${WORK_DIR}/run_scripts_halo"
...
for (( JDEVICE=0; JDEVICE<TOTAL_DEVICES; JDEVICE++ )); do
    ...
    JOB_NAME="halos_${JDEVICE}_${I_START}_${I_END}"
...
do
    ...
    echo "\$PWD";
    time srun python /mnt/ceph/users/spandey/quijote_v2_gotham/GOTHAM/prepare/process_halo_props.py \$i;
    echo "done";
done
